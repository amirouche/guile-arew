...
(test-group "bitwise"
 ...
 (test-group "bitwise/conversion"
  ...
  (test "test-108" #b1110101 (vector->bits (vector #t #f #t #f #t #t #t)))
  (test "test-109" #b00011010100 (vector->bits (vector #f #f #t #f #t #f #t #t)))
  (test "test-105" (vector #t #t #t #f #t #f #t #f #f) (bits->vector #b1010111 9))
